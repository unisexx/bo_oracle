<?php
class inspect_log extends Inspect_Controller
{
	public $modules_name = "monitor_log";
	public $modules_title = "ประวัติการใช้งานระบบติดตามและประเมินผล";
	...
	function index()
	{
		...
		$condition .= " AND module_name like 'inspect%' ";
		...
		if(@$_GET['action']=="export"){
			...
			$filename= "inspect_log_".date("Y-m-d_H_i_s").".xls";
			header("Content-Disposition: attachment; filename=".$filename);		
			$data['result']= $this->clog->where($condition)->order_by('process_date','desc')->get('','TRUE');
