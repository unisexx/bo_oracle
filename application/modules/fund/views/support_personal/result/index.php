...
<td>รอดำเนินการ</td>
<td><a href="<?=basename($_SERVER['PHP_SELF'])?>?act=form2"><img src="images/btn_approve.png" width="32" height="32" class="vtip" title="ผลการพิจารณา" /></a>    <input type="submit" name="button" id="button" value="x" class="btn_delete" /></td>
</tr>
<tr>
<td>2</td>
<td>นนทบุรี</td>
