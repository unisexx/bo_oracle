...
<h3>รายงานผลการปฏิบัติงานและเบิกจ่าย </h3>
<div id="tabs">
    <ul>
      <? 
...
<? if(@$_GET['bg_year']>0){ ?>
	<div style="clear: both"></div>	
	  <div style="float:right;padding-top: 10px;">
	  	<a href="monitor_operation_withdraw_act_report/print_page<?=$url_parameter;?>" target="_blank"><img src="images/printer_icon.gif" border="0" alt="พิมพ์หน้านี้" title="พิมพ์หน้านี้"></a>
	  	<a href="monitor_operation_withdraw_act_report/export<?=$url_parameter;?>" target="_blank"><img src="images/excel-button.png" border="0" alt="ส่งออกเป็น Excel" title="ส่งออกเป็น Excel"></a>
	  </div>
<div style="clear: both"></div>	
