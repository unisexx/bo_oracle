...
<div class="ico"><a href="mds_report_sum_perform"><img src="themes/mdevsys/images/icon/report_sum_perform.png" width="48" height="48" /><h4>ตารางสรุปผล การปฏิบัติราชการ</h4></a></div>
<div class="ico"><a href="mds_report_compare"><img src="themes/mdevsys/images/icon/report_compare.png" width="48" height="48" /><h4>การเปรียบเทียบปี การประเมินผล จากตัวชี้วัด</h4></a></div>
<? if(is_permit(login_data('id'),'1') != ''){ ?>
<div class="ico"><a href="mds_log"><img src="themes/mdevsys/images/icon/logfile.png" width="48" height="48" /><h4>Log File</h4></a></div>
<? } ?>
<div class="clear"></div>
</div>
<? if(is_permit(login_data('id'),'1') != ''){ ?>
...
<div class="lineico">
<div class="ico"><a href="mds_set_permission"><img src="themes/mdevsys/images/icon/permission.png" width="48" height="48" /><h4>สิทธิ์การใช้ระบบ</h4></a></div>
