...
<table class="tbadd">  
  <tr>
  	<th><?=$lv_title[1];?></th>
  	<td>
  		<?php echo form_dropdown('budgetstrategyid',get_option("id","title","cnf_strategy"," syear=".$budgetyear." AND  pid=0 "),@$prow['budgetstrategyid'],'','-- เลือกยุทธศาสตร์การจัดสรรงบประมาณ --');?>
  	</td>
  </tr> 
  <tr>
  	<th><?=$lv_title[2];?></th>
  	<td id="td_planid">
  		<?php echo form_dropdown('planid',get_option("id","title","cnf_strategy"," syear=".$budgetyear." AND  pid=".$prow['pid']),@$prow['id'],'','-- '.$lv_title[2].' --');?>
  	</td>
  </tr> 
  <tr>
    <th width="18%"> 
