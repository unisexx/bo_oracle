...
<table class="tbadd">  
  ...
  <tr>
  	...
  	<td id="td_sectiontargetid">
  		<?php echo form_dropdown('sectiontargetid',get_option("id","title","cnf_strategy"," syear=".$budgetyear." AND  pid=".$prow['pid']),@$prow['id'],'','-- '.$lv_title[6].' --');?>
  	</td>
  </tr>
  <tr>
    <th width="18%"> 
     ...
     <input type="hidden" name="lv" id="lv" value="7">     
