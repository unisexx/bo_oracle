...
<table class="tbadd">  
  ...
  <tr>
  	...
  	<td id="td_ministrytargetid">
  		<?php echo form_dropdown('ministrytargetid',get_option("id","title","cnf_strategy"," syear=".$budgetyear." AND  pid=".$prow['pid']),@$prow['id'],'','-- '.$lv_title[4].' --');?>
  	</td>
  </tr>  
  <tr>
    <th width="18%"> 
     ...
     <input type="hidden" name="lv" id="lv" value="5">     
