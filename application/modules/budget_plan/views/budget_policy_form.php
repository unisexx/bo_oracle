...
$().ready(function() {
	...
	$("#frmStrategy").validate({
		...
		messages: {
			...
			productivityid:"กรุณาเลือก<?=$lv_title[8];?>"
		}
    });	
...
<table class="tbadd">  
  ...
  <tr>
  	...
  	<td id="td_productivityid">
  		<?php echo form_dropdown('productivityid',get_option("id","title","cnf_strategy"," syear=".$budgetyear." AND  pid=".$prow['pid']),@$prow['id'],'','-- '.$lv_title[8].' --');?>
  	</td>
  </tr>
  <tr>
    <th width="18%"> 
     ...
     <input type="hidden" name="lv" id="lv" value="9">     
