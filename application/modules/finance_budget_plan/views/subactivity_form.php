...
$(document).ready(function(){
	...
	$("form").validate({
		...
		messages:{
			...
			subactivity_code:"กรุณากรอกรหัสกิจกรรมย่อย",
...
<table class="tbadd">
	...
	<tr>
	  ...
	  <td id="mainact"><?php echo @form_dropdown('mainactid',get_option('id','title',"fn_strategy where pid = ".@$parent['productivityid']." and mainactid = 0 and fnyear = ".$parent['fnyear']),@$parent['id'],'','-- เลือกกิจกรรมหลัก --')?></td>
	</tr>
	<tr>
		<th>รหัสกิจกรรมย่อย<span class="Txt_red_12"> *</span></th>
		<td><input type="text" name="subactivity_code" id="subactivity_code" value="<?=$self['subactivity_code'];?>"></td>
	</tr>
	<tr>
