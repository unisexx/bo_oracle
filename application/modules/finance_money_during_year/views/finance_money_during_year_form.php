...
<h3>เงินงบประมาณระหว่างปี (เพิ่ม / แก้ไข)</h3>

<form action="finance_money_during_year/save" method="post" enctype="multipart/form-data">
...
<tr>
  ...
  <td><span style="display:inline; float:left; padding-right:10px;">
  	<input type="hidden" name="id" id="id" value="<?=@$result['subject'];?>">
...
<div id="btnBoxAdd">
  <?php if(permission('finance_money_during_year', 'canedit')):?>
