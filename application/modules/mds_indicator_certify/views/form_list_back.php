...
<table class="tbadd">
  ...
  <tr>
	...
	?>
	<div id="btnBox"><input type="button" title="ตรวจรับรองผลตัวชี้วัด" value=" " onclick="document.location='<?=$urlpage?>/form_2/<?=@$users_keyer?>/<?=@$metrics_id?>'" class="btn_confirm_indicator vtip"></div>
	<? } } ?>
<?=@$pagination;?> 
<table class="tblist2">
<tr>
	...
	<th style="width: 10%">สถานะ <br/>รอบ 6 เดือน</th>
	<th style="width: 10%">สถานะ <br/>รอบ 9 เดือน</th>
	<th style="width: 10%">สถานะ <br/>รอบ 12 เดือน</th>
	<th>หมายเหตุ </th>
</tr>
<? 
...
<tr>
  ...
  <?
	  ...
	  if($result_status['round_month'] == '6'){
	  	$steps = $result_status['status_steps'];
	  	$status_6 = $result_status['status_dtl'];
	  }
	  
	  if($result_status['round_month'] == '9'){
	  	$steps = $result_status['status_steps'];
	  	$status_9 = $result_status['status_dtl'];
	  }
	  
	  if($result_status['round_month'] == '12'){
	  	$steps = $result_status['status_steps'];
	  	$status_12 = $result_status['status_dtl'];
	  }
  ?>
  <td><?=$steps?></td>
