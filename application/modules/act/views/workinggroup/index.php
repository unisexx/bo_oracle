<h3>บันทึก รายชื่อคณะทำงาน</h3>

<form method="get" action="act/workinggroup">
<div id="search">
<div id="searchBox">
...
<div id="btnBox"><input type="button" title="เพิ่มรายการ" value=" " onclick="document.location='act/workinggroup/form'" class="btn_add"/></div>
...
<tr class="cursor" onclick="window.location='act/workinggroup/form/<?php echo $row['id']?>'">
  <td><?php echo $i?></td>
  ...
  <td><a href="act/workinggroup/delete/<?php echo $row['id']?>" onclick="return confirm('<?php echo NOTICE_CONFIRM_DELETE?>')"><input type="submit" name="button" id="button" value="x" class="btn_delete" /></a></td>
</tr>
<?$i++;?>
<?php endforeach;?>
</table>
