...
<form method="get" action="act/welfare_benefit">
<div id="search">
<div id="searchBox">
...
<div id="btnBox"><input type="button" title="เพิ่มรายการ" value=" " onclick="document.location='act/welfare_benefit/form'" class="btn_add"/></div>
...
<tr class="cursor" onclick="window.location='act/welfare_benefit/form/<?php echo $row['organ_id']?>'">
  <td><?php echo $i?></td>
  ...
  <td><a href="act/welfare_benefit/delete/<?php echo $row['organ_id']?>" onclick="return confirm('<?php echo NOTICE_CONFIRM_DELETE?>')"><input type="submit" name="button" id="button" value="x" class="btn_delete" /></a></td>
</tr>
<?$i++;?> 
<?php endforeach;?>
</table>
