...
<div id="btnBox"><input type="button" title="เพิ่มรายการ" value=" " onclick="document.location='act/set_subcommittee_type/form'" class="btn_add"/></div>
</form>
...
<tr>
  ...
  <tr class="cursor" onclick="window.location='act/set_committee_type/form/<?php echo $row['id']?>'">
	  ...
	  <td><a href="act/set_subcommittee_type/delete/<?php echo $row['id']?>" onclick="return confirm('<?php echo NOTICE_CONFIRM_DELETE?>')"><input type="submit" name="button" id="button" value="x" class="btn_delete" /></td></a>
  </tr>
  <?$i++;?> 
  <?php endforeach;?>
</table>
