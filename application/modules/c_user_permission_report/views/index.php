...
<fieldset>
	<input type="button" id="btn_export" name="btn_export" value="ส่งออก" >
	ส่งออก :
	<?
	for($i=1;$i<=$num_part;$i++){
		echo "<input type=\"button\" id=\"spPrintPart\"  value=\"Part".$i."\"  onclick=\"window.open('c_user_permission_report/export?txtsearch=".@$_GET['txtsearch'].'&division='.@$_GET['division'].'&workgroup='.@$_GET['workgroup']."&page=$i');\"  >  |   ";
	}
	?>
</fieldset>
<table class="tblist">
