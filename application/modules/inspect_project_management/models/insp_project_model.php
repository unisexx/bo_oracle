<?php
class Insp_project_model extends MY_Model{
	
	public $table = 'insp_project';
	public $select= 'INSP_PROJECT.*,mt_project.title as projecttitle,  
       CASE
       ...
       END AS provincename';
	public $join= 'left join cnf_division on INSP_PROJECT.divisionid = cnf_division.id
