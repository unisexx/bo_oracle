...
<ul id="navmenu-h">
        ...
        <li><a href="#">ตั้งค่า +</a>
            <ul style="width:180px;">
                <?php if(permission('finance_budget_percent','canview')): ?><li><a href="finance_percent">หักเงินตามนโยบาย %</a></li><? endif;?>
            </ul>
        </li>
...
<span style="background:#FFF;">เข้าสู่ระบบโดย <a href="c_user/profile" class="link_login"><?php echo login_data('name'); ?></a>
	(
	<?php 
		echo login_data('division_title');
		if(login_data('user_province_id')!=2 && login_data('user_province_id')>0)echo ' จังหวัด'.login_data('user_province_title'); 
	?>)
</span>
