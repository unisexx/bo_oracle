...
<tr class="odd cursor" onclick="window.location='user.php?act=form'">
  <td>1</td>
  <td nowrap="nowrap">นางสาวกานคณิต ปัญญาศิริ</td>
  <td><img src="../user/images/department.png" width="28" height="28" class="vtip" title="ศูนย์เทคโนโลยีสารสนเทศและการสื่อสาร (ศทส) <br> กลุ่มการพัฒนาระบบสารสนเทศและการสื่อสาร" /></td>
...
<tr>
  ...
  <td><img src="../user/images/department.png" width="28" height="28" class="vtip" title="สำนักนโยบายและยุทธศาสตร์ (สนย.) &lt;br&gt; กลุ่มงบประมาณ" /></td>
