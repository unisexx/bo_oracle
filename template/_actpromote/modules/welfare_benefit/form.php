...
<input name="textfield33" type="text" id="textfield39" style="width:50px;"/>
  ...
  <tr>
    ...
    <span><input type="checkbox" name="checkbox3" id="checkbox3" /> คนชรา/ผู้สูงอายุ </span>
	...
	<span><input type="checkbox" name="checkbox4" id="checkbox4" /> เเรงงานนอกระบบ </span>
	<span><input type="checkbox" name="checkbox4" id="checkbox4" /> เเรงงานข้ามชาติเเละเเรงงานต่างด่าว </span>
    <span><input type="checkbox" name="checkbox4" id="checkbox4" /> ผู้ที่มีปัญหาสถานะบุคคล/คนไร้สัญชาติ/ชนกลุ่มน้อย </span>
	<span><input type="checkbox" name="checkbox4" id="checkbox4" /> ผู้ที่อยู่ในกระบวนการยุติธรรม </span>
	<span><input type="checkbox" name="checkbox4" id="checkbox4" /> คนจากจังหวัดชายเเดนภาคใต้ </span>
    ...
    <span><input name="checkbox4" type="checkbox" id="checkbox4" checked="checked" /> ผู้ด้อยโอกาสหรือกลุ่มเป้าหมายอื่น </span>
  ...
  <tr>
    <th>สาขาในการจัดสวัสดิการสังคม <span class="Txt_red_12"> *</span></th>
    <td>
    <span><input name="checkbox5" type="checkbox" id="checkbox6" checked="checked" /> การศึกษา </span> 
    <span><input name="checkbox5" type="checkbox" id="checkbox7" checked="checked" /> สุขภาพอนามัย </span> 
    <span><input type="checkbox" name="checkbox5" id="checkbox7" /> ที่อยู่อาศัย </span> 
    <span><input type="checkbox" name="checkbox5" id="checkbox7" /> การฝึกอาชีพ </span> 
    <span><input type="checkbox" name="checkbox5" id="checkbox7" /> การประกอบอาชีพ </span>
    <span><input type="checkbox" name="checkbox5" id="checkbox7" /> นันทนาการ </span>
    <span><input type="checkbox" name="checkbox5" id="checkbox7" /> กระบวนการยุติธรรม </span> 
	<span><input name="checkbox5" type="checkbox" id="checkbox5" checked="checked" /> การบริการสังคมทั่วไป</span> 
	<span><input type="checkbox" name="checkbox5" id="checkbox7" />อื่น ๆ </span>
<table class="tblist">
  <tr>
    <th>ลำดับ</th>
  ...
  <tr>
    <th>ลักษณะรูปแบบ และวิธีการดำเนินการ <span class="Txt_red_12"> *</span></th>
    <td>
    <span><input name="checkbox6" type="checkbox" id="checkbox8" checked="checked" /> การส่งเสริม </span> 
    <span><input type="checkbox" name="checkbox6" id="checkbox9" /> การพัฒนา </span> 
    <span><input type="checkbox" name="checkbox6" id="checkbox10" /> การสงเคราะห์ </span> 
    <span><input name="checkbox6" type="checkbox" id="checkbox10" checked="checked" /> การคุ้มครอง </span> 
    <span><input type="checkbox" name="checkbox6" id="checkbox10" /> การป้องกัน </span>
    <span><input name="checkbox6" type="checkbox" id="checkbox10" checked="checked" /> การแก้ไข </span> 
    <span><input type="checkbox" name="checkbox6" id="checkbox10" /> การบำบัดฟื้นฟู </span> 
    <span><input type="checkbox" name="checkbox6" id="checkbox10" /> อื่น ๆ </span>
<table class="tblist">
  <tr>
    <th>ลำดับ</th>
...
การบริหารงานด้านสวัสดิการสังคม(นโยบาย เเผน ข้อมูล ทุน สนับสนุน ประสานงาน)  ระบุ
<input name="input8" type="text" style="width:100px;" /></span>
<span>
<input name="checkbox11" type="checkbox" id="checkbox20" />
การกระทำทางสังคม(การพิทักษ์ รณรงค์ คุ้มครองสิทธิ์) ระบุ
<input name="input9" type="text" style="width:100px;" />
 </span>
<span><input name="checkbox8" type="checkbox" id="checkbox14" /> 
อื่นๆ ระบุ <input name="input6" type="text" style="width:100px;" />
</span></td>
  </tr>
  <tr>
...
วัสดุอุปกรณ์ สิ่งของ (in kind)  ระบุ
<input name="input10" type="text" style="width:100px;" />
    </span> <span>
