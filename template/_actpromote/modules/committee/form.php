...
<table class="tbadd">
  <tr>
    ...
    <td><input name="textfield15" type="text" id="textfield15" style="width:350px;"/></td>
  </tr>
  <tr>
...
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  <td>1</td>
  <td nowrap="nowrap">การประชุมคณะอนุกรรมการบริหารกองทุนส่งเสริมการจัดสวัสดิการสังคม</td>
  <td nowrap="nowrap">ห้องประชุมสำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์</td>
  <td nowrap="nowrap">05/12/2556</td>
  <td><input type="submit" name="button3" id="button3" title="แก้ไข" value=" " class="btn_edit vtip" />
    <input type="submit" name="button" id="button" title="ลบ" value=" " class="btn_delete vtip" /></td>
  </tr>
</table>
...
<h3>รายงานการประชุม (เพิ่ม/แก้ไข)</h3>
<table class="tbadd">
  <tr>
  ...
  <tr>
    <th>ครั้งที่ / พ.ศ.</th>
    <td><input name="textfield15" type="text" id="textfield15" style="width:30px;"/> / <input name="textfield16" type="text" id="textfield16" style="width:50px;"/></td>
  </tr>
  <tr>
    <th>สถานที่</th>
