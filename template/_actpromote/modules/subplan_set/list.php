...
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  <td>1</td>
  <td nowrap="nowrap">การพัฒนาสวัสดิการสังคมและสร้างความมั่นคงในการดำรงชีวิต</td>
  <td>ยุทธศาสตร์กระทรวง</td>
  <td><input type="submit" name="button" id="button" value="x" class="btn_delete" /></td>
  </tr>
<tr>
  <td>2</td>
  <td>ยุทธศาสตร์การใช้แนวคิดเศรษฐกิจพอเพียงเพื่อสร้างความมั่นคงของมนุษย์</td>
  <td>แผนยุทธศาสตร์ 5 ปี สร้างสวัสดิการสังคมไทย</td>
  <td><input type="submit" name="button2" id="button2" value="x" class="btn_delete" /></td>
</tr>
<tr class="odd">
  <td>3</td>
  <td>แผนงานสวัสดิการและพัฒนาที่อยู่อาศัยของประชาชน</td>
  <td>แผนงานชาติ</td>
  <td><input type="submit" name="button3" id="button3" value="x" class="btn_delete" /></td>
</tr>
<tr>
  <td>4</td>
  <td>แผนงานการจัดสวัสดิการสังคมเชิงรุก</td>
  <td>แผนยุทธศาสตร์ 5 ปี สร้างสวัสดิการสังคมไทย</td>
  <td><input type="submit" name="button4" id="button4" value="x" class="btn_delete" /></td>
</tr>
<tr class="odd">
  <td>5</td>
  <td nowrap="nowrap" class="odd cursor">นโยบายเร่งด่วน</td>
  <td>นโยบายรัฐบาล</td>
