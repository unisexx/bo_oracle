...
<div id="searchBox">ชื่อ - สกุล / Username
  <input name="input" type="text" style="width:250px;" />
  วันเวลาใช้งาน
<input name="textfield2" type="text" id="textfield2" style="width:70px;"  />
  <img src="images/calendar.png" width="16" height="16" /> ถึง
  <input name="textfield2" type="text" id="textfield3" style="width:70px;" />
...
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  ...
  <td nowrap="nowrap">&nbsp;</td>
  <td nowrap="nowrap">&nbsp;</td>
  <td nowrap="nowrap">นายวัชรินทร์ เจริญเผ่า</td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
