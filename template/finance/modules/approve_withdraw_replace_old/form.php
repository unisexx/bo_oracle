<h3>อนุมัติเบิกเงินแทนกัน (อนุมัติเบิกเงิน)</h3>
<div id="search">
  <div id="searchBox">เลขที่เอกสารการเบิกแทน
...
<tr>
  ...
  <th align="left">เลขที่เอกสารการเบิกแทน</th>
...
<tr class="odd">
  ...
  <td>9,000.00</td>
  <td><input type="submit" name="button" id="button" title="อนุุมัติเบิกเงิน" value=" " class="btn_approve cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=formadd'" /></td>
  </tr>
<tr>
  <td>2</td>
  <td>&nbsp;</td>
  ...
  <td>9,700.00</td>
  <td><input type="submit" name="button2" id="button2" title="อนุุมัติเบิกเงิน" value=" " class="btn_approve" /></td>
  </tr>
<tr class="odd">
  <td>3</td>
  <td>&nbsp;</td>
  ...
  <td>11,000.00</td>
  <td><input type="submit" name="button3" id="button3" title="อนุุมัติเบิกเงิน" value=" " class="btn_approve" /></td>
  </tr>
</table>
