...
<div class="link_budget_related">ค้นหาข้อมูล
  <select name="select7" onchange="window.location.href=this.options[this.selectedIndex].value">
    ...
    <option selected="selected" value="receive_for_withdraw_replace.php">รับเงินหน่วยงานอื่นเพื่อเบิกแทน</option>
...
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td><input type="submit" name="button4" id="button4" title="พิมพ์ข้อมูล" value=" " class="btn_printer" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form_print'" />
    <input type="submit" name="button" id="button" title="ลบรายการ" value="x" class="btn_delete" /></td>
  </tr>
<tr>
  <td>2</td>
  <td>&nbsp;</td>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td><input type="submit" name="button5" id="button5" title="พิมพ์ข้อมูล" value=" " class="btn_printer" />    <input type="submit" name="button2" id="button2" title="ลบรายการ" value="x" class="btn_delete" /></td>
  </tr>
<tr class="odd">
  <td>3</td>
  <td>&nbsp;</td>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td><input type="submit" name="button6" id="button6" title="พิมพ์ข้อมูล" value=" " class="btn_printer" />    <input type="submit" name="button3" id="button3" title="ลบรายการ" value="x" class="btn_delete" /></td>
  </tr>
</table>
