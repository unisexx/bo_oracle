...
<tr>
  ...
  <tr>
    ...
    <span><input type="checkbox" name="checkbox4" id="checkbox4" /> ผู้ติดเชื้อเโรคอันตราย(เชื้อเอชไอวี)</span>
...
การบริการสังคมทั่วไป</span> <span>
  ...
  <tr>
    ...
    <td><span>
      ...
      <input name="input16" type="text" style="width:100px;" />
        ...
        สวัสดิการกลุ่มชน/งานสังคมสงเคาระห์กลุ่มชน ระบุ
        <input name="input16" type="text" style="width:100px;" />
        </span> <span>
          ...
          <input name="input16" type="text" style="width:100px;" />
            ...
            <input name="input16" type="text" style="width:100px;" />
             ...
             การบริหารงานด้านสวัสดิการสังคม(นโยบาย เเผน ข้อมูล ทุน สนับสนุน ประสานงาน)  ระบุุ
             <input name="input16" type="text" style="width:100px;" />
             </span> <span>
             <input name="checkbox16" type="checkbox" id="checkbox54" />
            การกระทำทางสังคม(การพิทักษ์ รณรงค์ คุ้มครองสิทธิ)  ระบุ
             <input name="input16" type="text" style="width:100px;" />
             </span><span>
			 <input name="checkbox8" type="checkbox" id="checkbox14" /> 
			อื่นๆ ระบุ <input name="input6" type="text" style="width:100px;" />
