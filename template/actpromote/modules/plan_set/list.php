...
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  <td>1</td>
  <td nowrap="nowrap">แผนยุทธศาสตร์ 5 ปี สร้างสวัสดิการสังคมไทย</td>
...
<tr>
  <td>4</td>
  <td>แผนงานตามยุทธศาสตร์ 5 ปี สร้างสวัสดิการสังคมไทย</td>
  <td><input type="submit" name="button4" id="button4" value="x" class="btn_delete" /></td>
</tr>
<tr class="odd">
  <td>5</td>
  <td nowrap="nowrap" class="odd cursor">แผนงานชาติ</td>
