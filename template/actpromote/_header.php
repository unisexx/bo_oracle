...
<div id="home"><a href="index.php"><img src="../images/home.png" width="32" height="32" class="vtip" title="หน้าหลักงานพ.ร.บ.ส่งเสริมสวัสดิการ"/></a></div>
<div id="menu">
<ul id="navmenu-h">
        <li><a href="#">บันทึก +</a>
          <ul style="width:300px;">
            <li><a href="welfare_benefit.php">องค์กรสาธาณประโยชน์</a></li>
            <li><a href="welfare_community.php">องค์กรสวัสดิการชุมชน</a></li>
            <li><a href="welfare_state.php">หน่วยงานของรัฐ</a></li>
