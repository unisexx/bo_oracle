<h3>ตั้งค่า ยุทธศาสตร์กระทรวง  </h3>
<div id="search">
<div id="searchBox">
  ชื่อยุทธศาสตร์กระทรวง   
...
<tr>
  ...
  <th align="left">ชื่อยุทธศาสตร์กระทรวง  </th>
  <th align="left">เป้าหมายการให้บริการกระทรวง </th>
  <th align="left">ลบ</th>
  </tr>
<tr class="odd cursor" onclick="window.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'">
  <td>1</td>
  <td nowrap="nowrap">ส่งเสริมการขับเคลื่อนการพัฒนา ป้องกัน และแก้ไขปัญหาสังคม</td>
  <td>ประชากรเป้าหมายได้รับการพัฒนาและการคุ้มครองตามสิทธิอย่างเท่าเทียม</td>
  <td><input type="submit" name="button" id="button" value="x" class="btn_delete" /></td>
  </tr>
<tr>
  <td>2</td>
  <td>เสริมพลังและสร้างการมีส่วนร่วม</td>
  <td>ประชากรเป้าหมายได้รับการพัฒนาและการคุ้มครองตามสิทธิอย่างเท่าเทียม</td>
...
<tr class="odd">
  ...
  <td>ประชากรเป้าหมายได้รับบริการสวัสดิการทางสังคมเพื่อคุณภาพชีวิตที่ดี</td>
  <td><input type="submit" name="button3" id="button3" value="x" class="btn_delete" /></td>
</tr>
<tr>
  <td>4</td>
  <td>ส่งเสริมการขับเคลื่อนการพัฒนา ป้องกัน และแก้ไขปัญหาสังคม</td>
  <td>ประชากรเป้าหมายได้รับบริการสวัสดิการทางสังคมเพื่อคุณภาพชีวิตที่ดี</td>
